#include "../header/PRemoveMenu.h"

PRemoveMenu::PRemoveMenu(void) {}

PRemoveMenu::PRemoveMenu(float x, float y, float width, float height) :
...
PRemoveMenu::PRemoveMenu(Vector2 pos, Vector2 size) :
...
void PRemoveMenu::draw(void) {
    InputBox.draw();
    GO.draw();
}

vector<string> PRemoveMenu::update(void) {
    vector<string> res;
