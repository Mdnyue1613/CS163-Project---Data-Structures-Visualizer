...
PInsertMenu::PInsertMenu(float x, float y, float width, float height) :
    ...
    Mode(Vector2{x + PConstants::PFunctionArea::spaceX, y + PConstants::PFunctionArea::boxHeight + 2.f * PConstants::PFunctionArea::spaceY}, 
        Vector2{width - 2.f * PConstants::PFunctionArea::spaceX, PConstants::PFunctionArea::boxHeight}, 
        PConstants::PFunctionArea::boxOutlineThickness, 
        PConstants::PFunctionArea::boxColor, 
        PConstants::PFunctionArea::outlineBoxColor, 
    {"Head", "Tail", "After (0-indexed)"}, PConstants::PFunctionArea::textSize),
