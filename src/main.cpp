...
float PConstants::PFunctionArea::boxHeight = 45;
float PConstants::PFunctionArea::boxWidth = 143;
...
Vector2 PConstants::PSlider::pos = {900.f, 750.f};
Vector2 PConstants::PSlider::size = {270.f, 15.f};
Color PConstants::PSlider::barColor = SEASHELL;
Color PConstants::PSlider::thumbColor = BLACK;
Color PConstants::PSlider::thumbHighlightColor = DARKGRAY;
